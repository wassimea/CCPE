...
<link rel='stylesheet' type='text/css' href='css/main.css'>
  ...
  <% request.getRequestDispatcher("link.html").include(request,response); %>
    ...
    <form action="show_course" method="GET">
    
	<label>Select Course:</label><br>
      <select name="course" onmousedown="if(this.options.length>8){this.size=0;}"  onchange='this.size=0;' onblur="this.size=0;" size = "0">
        <% for(int i = 0 ; i < c.getCoursesWithCRN().size() ; i++)
        {
